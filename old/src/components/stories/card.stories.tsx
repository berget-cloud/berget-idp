    ...
    render: () => (
        <Card className="max-w-md">
            <CardHeader>
                ...
                <CardDescription>
                    A description with more detailed content to demonstrate how it handles
                    long text.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <p>
                    This card contains a lot of content. It’s a good example of what
                    happens when content extends the usual length. The Card component is
                    flexible enough to handle varying amounts of text and other
                    components.
                </p>
            </CardContent>
            <CardFooter>
